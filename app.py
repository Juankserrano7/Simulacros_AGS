...
if not st.session_state.authenticated:
    if LOGO_BASE64:
        st.markdown(
            f"<div class='login-logo' style='margin-top:0.10rem; transform: scale(1); transform-origin: top left;'><img src='data:image/png;base64,{LOGO_BASE64}' alt='Logo PreIcfes'></div>",
            unsafe_allow_html=True
        )
    st.markdown(
        """
