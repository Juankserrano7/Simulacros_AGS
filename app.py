...
if not st.session_state.authenticated:
    if LOGO_BASE64:
        st.markdown(
            f"<div class='login-logo' style='margin-top:1rem; transform: scale(1.25); transform-origin: top left;'><img src='data:image/png;base64,{LOGO_BASE64}' alt='Logo PreIcfes'></div>",
            unsafe_allow_html=True
        )
    st.markdown(
        """
